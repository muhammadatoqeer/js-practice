...
console.log(str.anchor("example")); // Output: <a name="example">Hello, World!</a> (wraps string in <a> tag)
...
// codePointAt() - Returns the code point value of the character at a given position.
